...
PARSER_FILES =	parse_scene validation_scene parse_helpers validate_helpers \
                ...
                log_parsed_data
IMG_FILES = 	create_win win_events init_img_data get_start_img set_viewport
VEC_OPS_FILES =	basic_vector_ops get_coord_dist get_vector_length normalize_vector copy_vector scale_vector
